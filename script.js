...
function list_fun(elm) {
    ...
    <li>
        <div class="container">
          ...
          <button class="btn" id="${elm['id']}">
            <svg class="cards-decr" id="${elm['id']}" xmlns="http://www.w3.org/2000/svg" width="10" height="2" fill="none" viewBox="0 0 10 2"><path fill="#fff" d="M0 .375h10v1.25H0V.375Z"/></svg>
            <img class="cards-cartImg" src="assets/images/icon-add-to-cart.svg">
            <p class="cards-btn-txt">Add to Cart</p> 
            <svg class="cards-incr" id="${elm['id']}" xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10"><path fill="#fff" d="M10 4.375H5.625V0h-1.25v4.375H0v1.25h4.375V10h1.25V5.625H10v-1.25Z"/></svg>
          </button>
        </div>
        ...
        confirmBtn.addEventListener('click', () => {
            ...
            datas.map((elm) => {
                ...
                <div class="order-subcontainer">
                    <svg id="order-svg" width="43" height="43" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            window.location.href = '#order-svg';
        })
    }
    //SVG Button Event
    svgs.forEach((svg) => {
